    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>자녀의 처방전 등록</Text>
        </View>
              ...
              {image ? (
                <View style={styles.previewContainer}>
                  ...
                  <View style={styles.previewOverlay}>
                    ...
                    <Text style={styles.previewText}>처방전 등록 완료!</Text>
                  </View>
                </View>
              ) : (
          ...
          {image ? (
            <>
              ...
              <TouchableOpacity style={styles.primaryButton}>
                <Text style={styles.primaryButtonText}>약봉투 저장하기</Text>
            ...
            <>
              ...
              >
                ...
                <Text style={styles.secondaryButtonText}>갤러리에서 선택하기</Text>
              </TouchableOpacity>
            </>
          )}
        </View>
